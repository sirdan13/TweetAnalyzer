...
//						System.exit(-1);
						...
						SortedSet<WeightedWord> relw1 = topmostWordsFromATweetSet(tlist2, kb, 60);
				...
				//				List<Tweet> newList = selectTweetsForSubject(tlist, s);
								...
								//TODO impostare lettura dizionari per n lingue
								...
								*/
								...
								try {
									...
									ArrayList<Tweet> tweetItaliani = new ArrayList<Tweet>();
									tweetItaliani=languageFilter(subApp.getSubjectTweetList());
								//	SortedSet<WeightedWord> topmostForSubject = topmostWordsFromATweetSet(subApp.subjectTweetList, kb, 10);
									SortedSet<WeightedWord> topmostForSubject = topmostWordsFromATweetSet(tweetItaliani, kb, 10);
									...
									//	List<String> listIDs = tweetsContainingWord(w1.getType(), tlist1);
										...
										try {
											...
											System.out.println("Impossibile salvare la Statistic_TopMostWord dell'intervallo di analisi " + analysisInterval.getId());
										}
										System.out.println(w1.getType() + "; TF: " + w1.getTf() + "; Weight:" + df.format(w1.getWeight()));
									}
									...
									System.out.println("Impossibile salvare Statistic_sentiment relative al soggetto" + sub.getName());
								}
							}
							System.out.println();
						}
						...
						List<Subject> subjects1 = cutList(listsub);
...
//	private static List<String> tweetsContainingWord(String type,  List<Tweet> tlist1)
	...
	private static List<String> tweetsContaining2Words(String type, List<Tweet> tlist1) {
	...
	public static WordAndID wordAndId(List<Tweet> tlist, KnowledgeBase kb, int k) {
	...
	public static String[] trendingWordsRankings(List<Tweet> tlist, KnowledgeBase kb, int k) {
...
//		return outlist;
	...
	public static List<Tweet> extractRelevantTweetlist(List<Tweet> inputlist, KnowledgeBase kb, double threshold, String[] relevantWords) {
	...
	public static List<Tweet> extractRelevantTweetlist(List<Tweet> inputlist, KnowledgeBase kb, String[] relevantWords) {
	 ...
	 *         threshold
	 */
	public static SortedSet<WeightedWord> relevantWords(Tweet t, KnowledgeBase kb, double threshold) {
	 ...
	 *         relevancy threshold
	 */
	public static SortedSet<WeightedWord> relevantWords(Tweet t, KnowledgeBase kb) {
	 ...
	 *         weight
	 */
	public static SortedSet<WeightedWord> weightedWordsFromATweetSet(List<Tweet> tset, KnowledgeBase kb) {
	 ...
	 */
	public static SortedSet<WeightedWord> relevantWordsFromATweetSet(List<Tweet> tset, KnowledgeBase kb, double threshold) {
	 ...
	 *         sorted by weight (descending order)
	 */
	public static SortedSet<WeightedWord> relevantWordsFromATweetSet(List<Tweet> tset, KnowledgeBase kb) {
	 ...
	 *            the relevancy threshold
	 */
	public static void computeRelevantWords(List<Tweet> tweetlist, KnowledgeBase kb, Double threshold) {
	 ...
	 *            the reference knowledge base
	 */
	public static void computeRelevantWords(List<Tweet> tweetlist, KnowledgeBase kb) {
	 ...
	 *         relevancy
	 */
	public static SortedSet<WeightedWord> topmostWordsFromATweetSet(List<Tweet> tset, KnowledgeBase kb, int k) {
	 ...
	 *         relevancy
	 */
	public static SortedSet<WeightedWord> topmostWordsFromATweetSetNoKeywords(List<Tweet> tset, List<String> keywords, KnowledgeBase kb, int k) {
	 ...
	 */
	public static HashMap<String, Integer> countWords(List<Tweet> tweetlist, List<String> wordlist) {
	 ...
	 */
	public static SortedSet<WordCount> countWordsSorted(List<Tweet> tweetlist, List<String> wordlist) {
	 ...
	 * @return the list of clusters
	 */
	public static List<Cluster> tweetClusterer(List<Tweet> tweetlist, KnowledgeBase kb, Integer nclust) {
	 ...
	 * @return the list of clusters
	 */
	public static List<Cluster> tweetClusterer(List<Tweet> tweetlist, KnowledgeBase kb, Integer nclust, double threshold) {
	 ...
	 * @return list of updated clusters
	 */
	public static List<Cluster> tweetClustererUpdate(List<Cluster> oldclusters, List<Tweet> tweetlist, KnowledgeBase kb) {
	...
	public static Sentiment[] setAndGetSentimentForSubject(List<Tweet> tlist, Subject s)
		...
		for (int i = 0; i < tlist.size(); i++) {
			if (tlist.get(i).getLike() && !tlist.get(i).getAmbiguo())
				s.getLikeTweetList().add(tlist.get(i).getTweetID());
			if (tlist.get(i).getHilarious() && !tlist.get(i).getAmbiguo())
				s.getHilariousTweetList().add(tlist.get(i).getTweetID());
			if (tlist.get(i).getAngry() && !tlist.get(i).getAmbiguo())
				s.getAngryTweetList().add(tlist.get(i).getTweetID());
			if (tlist.get(i).getSad() && !tlist.get(i).getAmbiguo())
				s.getSadTweetList().add(tlist.get(i).getTweetID());
